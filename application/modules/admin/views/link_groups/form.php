...
<form class="form-horizontal" role="form" action="admin/link_groups/save/<?php echo $value->id?>" method="post" >
	
	<div class="form-group" >
		<label for="title" class="col-sm-2 control-label" >ชื่อประเภท</label>
		<div class="col-lg-4" >
			<input type="text" class="form-control" name="title" placeholder="กรอกประเภทเว็บลิ้งค์" value="<?php echo $value->title?>" />
		</div>
	</div>
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<a href="admin/link_groups" class="btn btn-danger" > Cancel</a>
		</div>
	</div>
