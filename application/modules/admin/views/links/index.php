...
<?php if(permission("links","create")):?>
<form action="admin/orders/ma_links/links" method="post" >
<?php endif?>
<table class="table table-bordered table-hover table-responsive table-striped" >
	...
	<thead>
		<tr>
			...
			<th style="width: 80px;" >แบนเนอร์</th>
			<th>ชื่อเว็บไซต์</th>
			<th>URL</th>
			<th style="width: 160px;" >วันที่สร้าง / วันที่แก้ไข</th>
			<th style="width: 160px;" >
				<?php if(permission("links","create")):?>
				<a href="admin/links/form?g=<?php echo $_GET["g"]?>" class="btn btn-primary" ><span class="glyphicon glyphicon-edit" ></span> เพิ่ม</a>
				<?php endif?>
			</th>
		</tr>
	</thead>
	...
	<tbody>
		...
		<tr>
			...
			<td><img src="<?php echo $value->image?>" width="136" height="38"></td>
			<td>
			...
			<td>
				<?php if(permission("links","create")):?>
				<a href="admin/links/form/<?php echo $value->id?>" class="btn btn-primary" ><span class="glyphicon glyphicon-wrench" ></span> แก้ไข</a>
				<?php endif?>
				<?php if(permission("links","delete")):?>
				<a href="admin/links/delete/<?php echo $value->id?>" class="btn btn-danger" onclick="return confirm('ต้องการลบ <?php echo $value->title?> หรือไม่')" ><span class="glyphicon glyphicon-trash" ></span> ลบ</a>
				<?php endif?>
			</td>
		</tr>
		<?php endforeach?>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('button[data-loading-text]').click(function () {
		    ...
		    var id = btn.attr("id");
		    $.post("admin/approve/link/"+id,{status:status});
		    return false;
