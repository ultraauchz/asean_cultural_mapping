<?php
$CI =& get_instance();
$main_menu = $CI->db->getarray("SELECT * FROM acm_menus WHERE show_state = 'y' and parent_id = 0 ORDER BY order_no ");
$current_menu = $CI->db->getrow("SELECT * FROM acm_menus WHERE id = ".$menu_id);
?>
