...
<form action="admin/orders/ma_hilight/hilights" method="post" >
<?php endif?>
<table class="table table-bordered table-hover table-responsive table-striped" >
	...
	<thead>
		<tr>
			...
			<th style="width: 160px;" >
				<?php if(permission("hilights","create")):?>
				<a href="admin/hilights/form" class="btn btn-primary" ><span class="glyphicon glyphicon-edit" ></span> เพิ่ม</a>
				<?php endif?>
			</th>
		</tr>
	</thead>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<?php if(permission("hilights","create")):?>
				<a href="admin/hilights/form/<?php echo $value->id?>" class="btn btn-primary" ><span class="glyphicon glyphicon-wrench" ></span> แก้ไข</a>
				<?php endif?>
				<?php if(permission("hilights","delete")):?>
				<a href="admin/hilights/delete/<?php echo $value->id?>" class="btn btn-danger" onclick="return confirm('ต้องการลบ <?php echo $value->title?> หรือไม่')" ><span class="glyphicon glyphicon-trash" ></span> ลบ</a>
				<?php endif?>
			</td>
		</tr>
		<?php endforeach?>
