...
<div id="col-page">
        ...
        <form id="loginForm" enctype="multipart/form-data" method="post" data-toggle="validator"action="front/member/login">
      ...
      <div class="title-page">Register Account</div>
		<br>
		      	<form id="registerForm" enctype="multipart/form-data" method="post" data-toggle="validator" role="form" action="front/member/register">
