<html><head>
    ...
    <!-- iCheck -->
    <link href="themes/admin/medias/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css">
  ...
  <body class="login-page" cz-shortcut-listen="true">
    <div class="login-box">
      <div class="login-logo">
        <a href="home"><b>ASEAN CULTURAL MAPPING</b>Siteadmin</a>
      </div><!-- /.login-logo -->
      <form method="post" enctype="multipart/form-data" action="siteadmin/login/signin">
